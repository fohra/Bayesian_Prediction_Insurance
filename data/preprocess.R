preprocess <- function(data){
  ...
  data$smoker <- as.numeric(data$smoker) #no smoking 1, smoking 2
  data$smoker[data$smoker == 1] <- 0 #no smoking 0, smoking 2
  data$smoker[data$smoker == 2] <- 1 #no smoking 0, smoking 1
